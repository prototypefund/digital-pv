...
mixin Paddings {
  ...
  static const EdgeInsets trustedPersonPowerPadding = EdgeInsets.only(top: 32);
  static const EdgeInsets checkboxPadding = EdgeInsets.only(top: 16);
  static const EdgeInsets groupPowerOfAttorneyCheckboxPadding = EdgeInsets.only(left: 32);
