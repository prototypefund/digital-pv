...
"""),
  ...
  List<Widget> editItem(BuildContext context, PositiveAspectsViewModel viewModel) {
    return [
      Row(
        children: [
          card(
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  MarkdownBody(content: viewModel.describePositiveAspectTitle),
...
""",
  ...
  PageController pageController(PositiveAspectsViewModel viewModel, double viewPortFraction) {
    return viewModel.pageController =
        PageController(viewportFraction: viewPortFraction, initialPage: items.length > 4 ? 1 : 0);
  }

  List<Widget> selectItem(BuildContext context, PositiveAspectsViewModel viewModel) {
    return [
